                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            ...
                            <img width="370px" class="img-fluid" src="<?= $B ?>/assets/images/project/healthcare/1.webp" alt="Doctor sign-up profile screen in healthcare app">
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <div class=" mt-3">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
                            <img width="370px" class="img-fluid" src="<?= $B ?>/assets/images/project/healthcare/2.webp" alt="Healthcare app dashboard showing active patients and doctors">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInLeft;">
                            <img width="370px" class="img-fluid" src="<?= $B ?>/assets/images/project/healthcare/3.webp" alt="Doctor profile management screen in healthcare app">
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <div class=" mt-3">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
                            <img width="370px" class="img-fluid" src="<?= $B ?>/assets/images/project/healthcare/4.webp" alt="Doctor inquiries management screen in healthcare app">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInLeft;">
                            <img width="370px" class="img-fluid" src="<?= $B ?>/assets/images/project/healthcare/5.webp" alt="Doctor network screen in healthcare app">
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <div class=" mt-3">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
                            <img width="370px" class="img-fluid" src="<?= $B ?>/assets/images/project/healthcare/6.webp" alt="Doctor contact patient feature screen in healthcare app">
                        </div>
                    </div>
                </div>
            </div>
