...
<section class="about-page snapp white__main">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                        <div class=" mt-2">
                            <div>
                                ...
                                <h1 class="section-title__title mb-3">Expert Development for Next-Gen Social Networking Application</h1>
                            </div>
                            <p class="laundry-content"> Who doesn’t want to have a caring and loving partner around these days?
                                Everybody does! With Swype - getting your better half now becomes simpler than you can
                                ever imagine! Connected through photo guides and matching filter profiles, this
                                location-based dating app is the perfect way to bring people from all walks of life
                                together. </p>
                    ...
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            ...
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/project/swype/swype_screen1.webp" alt="Social networking app dating filter options screen"> </div>
                    </div>
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            <div class="icon-counting mb-3">1</div>
                            <h2 class="section-title__title mb-3">Apt Filtering Option</h2>
                            <p class="">One should filter their dating needs by providing age range, maximum distance,
                                intention to meet, and love interest. This feature helps users navigate the right niches
                                that share similar interests and values. </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            ...
                            <h2 class="section-title__title mb-3">Swipe! Swipe!</h2>
                            <p class="">Like Tinder, this dating app has a swipe right, left, and up feature. Swipe
                                right for approval, swipe left for disapproval and swipe up for super likes (for those
                                who talk to you the most). </p>
                        </div>
                    </div>
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/project/swype/swype_screen2.webp" alt="Social networking app swipe feature screen"> </div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInLeft;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/project/swype/swype_screen3.webp" alt="Social networking app photo upload feature screen"> </div>
                    </div>
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            <div class="icon-counting mb-3">3</div>
                            <h2 class="section-title__title mb-3">Photo Uploads</h2>
                            <p class="">Users upload photos that make an impression and attract the right partner.
                                Connections are made, for example, through photos, which are a good barrier to entry to
                                the pool by an undisturbed person.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            ...
                            <h2 class="section-title__title mb-3">Connect Via Photo</h2>
                            <p class="">To start a conversation, both end-users have to like each other's photos. The
                                same effort on both sides can unlock the SMS function of the mobile app.</p>
                        </div>
                    </div>
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/project/swype/swype_screen4.webp" alt="Social networking app connect via photo feature screen"> </div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInLeft;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/project/swype/swype_screen5.webp" alt="Social networking app text chat feature screen"> </div>
                    </div>
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            <div class="icon-counting mb-3">5</div>
                            <h2 class="section-title__title mb-3">Text Chatting</h2>
                            <p class="">The chat feature of this dating app gives users the opportunity to get to know
                                each other better and discuss their shared interests before starting to date.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            ...
                            <h2 class="section-title__title mb-3">In-App Purchase</h2>
                            <p class="">The chat feature of this dating app allows users to get to know each other better and discuss their shared interests before starting to date.</p>
                        </div>
                    </div>
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/project/swype/swype_screen6.webp" alt="Social networking app in-app purchase feature screen"> </div>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-xl-6">
                        <div class="welcome-three__left">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">Social Networking Application Summary</h2>
                            </div>
                            <p class="welcome-three__text">ArtisticWebServices have succeeded in developing applications in
                                various business genres, one of which is a dating application. Swype is one of the
                                dating apps designed for people from Ghana, and Africa with some seamless features.
                                Connected through photo guides and matching filter profiles, this location-based dating
                                app is the perfect way to bring people from all walks of life together.
                                <br>
                                <br> This dating app has a really cool "Super Likes" feature that allows users to
                                generate interest in search options, unlike Tinder which doesn't have such availability.
                            </p>
                        </div>
                    </div>
