            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            <div>
                                <h1 class="section-title__title mb-3" style="color: #000">Enterprise App Development Company</h1>
                            </div>
                            <p class="">Are you manually handling the time-consuming part of your business? Want to
                                automate your complex enterprise business process with an enterprise mobility solution?
                                We have experience developing 10+ custom enterprise solutions with advanced features,
                                including cloud storage, real-time analytics, push notifications, and data security.</p>
                    ...
                    <div class="col-xl-5">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            ...
                            <img class="img-fluid" src="<?= $B ?>/assets/images/enterprise-development-img.webp"
                                alt="Award-Winning Enterprise App Development Company">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-6">
                        <div class="welcome-three__left">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">WHO IS ArtisticWebServices?</h2>
                            </div>
                            <p class="welcome-three__text">ArtisticWebServices is an award-winning enterprise application
                                development and design agency that has worked with top clients in dozens of industries.
                                We've created top-ranked apps for Fortune 500 companies MGM and Rite Aid. We translate
                                favorite sites from 9Gag and Crunchbase into mobile apps. Our extensive portfolio
                                reflects our high-quality standards, no matter the product. </p>
                ...
                <div class="row">
                    <div class="col-xl-6 wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                        <div class="why-choose-one__left">
                            <div class="why-choose-one__img"> <img src="<?= $B ?>/assets/images/enterprise-development-img2.webp"
                                    alt="Award-Winning Enterprise App Development Company"> </div>
                    ...
                    <div class="col-xl-6">
                        <div class="why-choose-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">Increase efficiency and profitability with the right
                                    mobile enterprise solution</h2>
                            </div>
                            <p class="why-choose-one__right-text">A successful mobile app intelligently combines your
                                users, your business or market needs, and the product itself. These factors must work
                                together to create a mobile app that offers outstanding usability and performance and
                                unique value for your business. Our enterprise <a href="<?= $B ?>/services/mobile-app-development.php" style="color: #d23931">app development services</a> include mobile
                                strategy and consultation to help your organization craft a mobile vision that
                                encompasses every enterprise's needs!</p>
                            </br>
                            <p>With the right business intelligence, tools, and methods, you can ensure that your
                                company's mobile apps are well-developed and tailored to your business needs.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="why-choose-one__right get-unprec">
                            <div class="section-title text-left">
                                <!-- <span class="section-title__tagline">why choose us</span> -->
                                <h2 class="section-title__title">Proefficient developers creating intuitive enterprise
                                    apps.</h2>
                            </div>
                            <p class="why-choose-one__right-text">Enterprise cellular app improvement is an iterative
                                procedure of troubleshooting and non-stop development to make your product successful.
                                Devices and technology will change, and so will the needs and behavior of your
                                customers.</p>
                            </br>
                            <p>With the right tools and time-tested methods, you can overcome any challenge and ensure
                                your products deliver value to your customers and business year after year.</p>
                        </div>
                    </div>
                    <div class="col-xl-6 wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
                        <div class="why-choose-one__right get-unprec01">
                            <div class="why-choose-one__img"> <img src="<?= $B ?>/assets/images/enterprise-development-img3.webp"
                                    alt="Award-Winning Enterprise App Development Company"> </div>
        ...
        <section class="services-two">
            ...
            <div class="container">
                <div class="section-title text-center">
                    <h2 class="section-title__title col-md-8 m-auto mb-3">Achieve your business goals by developing
                        mobile apps</h2>
                    <p>Smartly combine your business goals and technology solutions for better results.</p>
                </div>
                <ul class="list-unstyled clearfix services-two__list">
                    <!--Services Two Single-->
                    <li class="services-two__single wow fadeInUp" data-wow-delay="200ms"> <img
                            src="<?= $B ?>/assets/images/icon/Optimize.webp" class="mb-2"
                            alt="Award-Winning Enterprise App Development Company">
                        <h3 class="services-two__title">Optimize your tactics</h3>
                        <p class="services-two__text">Collect and use data to create great user experiences and increase
                            the effectiveness of your efforts.</p>
                    </li>
                    <!--Services Two Single-->
                    <li class="services-two__single wow fadeInUp" data-wow-delay="400ms"> <img
                            src="<?= $B ?>/assets/images/icon/Improve.webp" class="mb-2"
                            alt="Award-Winning Enterprise App Development Company">
                        <h3 class="services-two__title">Improve process efficiency</h3>
                        <p class="services-two__text">Analyze how you work and identify practices that can be optimized
                            to reduce wasted processes.</p>
                    </li>
                    <!--Services Two Single-->
                    <li class="services-two__single wow fadeInUp" data-wow-delay="600ms"> <img
                            src="<?= $B ?>/assets/images/icon/employees.webp" class="mb-2"
                            alt="Award-Winning Enterprise App Development Company">
                        <h3 class="services-two__title">Improve the efficiency</h3>
                        <p class="services-two__text">Make sure your employees can access the data they need directly
                            from a central database or solve problems on the go.</p>
                    </li>
                    <!--Services Two Single-->
                    <li class="services-two__single wow fadeInUp" data-wow-delay="800ms"> <img
                            src="<?= $B ?>/assets/images/icon/flexibility.webp" class="mb-2"
                            alt="Award-Winning Enterprise App Development Company">
                        <h3 class="services-two__title">Supports organizational flexibility</h3>
                        <p class="services-two__text">Test and implement innovative ideas quickly to keep up with the
                            ever-changing market.</p>
                    </li>
                    <!--Services Two Single-->
                    <li class="services-two__single wow fadeInUp" data-wow-delay="200ms"> <img
                            src="<?= $B ?>/assets/images/icon/Expand.webp" class="mb-2"
                            alt="Award-Winning Enterprise App Development Company">
                        <h3 class="services-two__title">Expand your reach</h3>
                        <p class="services-two__text">1.8 billion people worldwide buy goods online. Selling is more
                            convenient, easy, and fast.</p>
                    </li>
                    <!--Services Two Single-->
                    <li class="services-two__single wow fadeInUp" data-wow-delay="400ms"> <img
                            src="<?= $B ?>/assets/images/icon/audiences.webp" class="mb-2"
                            alt="Award-Winning Enterprise App Development Company">
                        <h3 class="services-two__title">Reach new audiences</h3>
                        <p class="services-two__text">Offer relevant and fresh content to customers through mobile apps
                            to increase their engagement and take advantage of the power of recommendations.</p>
                    </li>
                    <!--Services Two Single-->
                    <li class="services-two__single wow fadeInUp" data-wow-delay="600ms"> <img
                            src="<?= $B ?>/assets/images/icon/Increase.webp" class="mb-2"
                            alt="Award-Winning Enterprise App Development Company">
                        <h3 class="services-two__title">Increase brand exposure</h3>
                        <p class="services-two__text">Apps account for more than 90% of the time spent online with
                            smartphones. Be where your customers are.</p>
                    </li>
                    <!--Services Two Single-->
                    <li class="services-two__single wow fadeInUp" data-wow-delay="800ms"> <img
                            src="<?= $B ?>/assets/images/icon/engagement.webp" class="mb-2"
                            alt="Award-Winning Enterprise App Development Company">
                        <h3 class="services-two__title">Build engagement and loyalty</h3>
                        <p class="services-two__text">Send the proper advertising messages at the proper time and use
                            push notifications to boost consumer loyalty.</p>
                    </li>
                </ul>
            </div>
        </section>
        <section class="why-choose-one">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                        <div class="why-choose-one__left">
                            <div class="why-choose-one__img"> <img src="<?= $B ?>/assets/images/enterprise-development-img4.webp"
                                    alt="Award-Winning Enterprise App Development Company"> </div>
                            <div class="why-choose-one-box-1"></div>
                            <div class="why-choose-one-box-2"></div>
                            <!-- <div class="why-choose-one-box-3"></div> -->
                    ...
                    <div class="col-xl-6">
                        <div class="why-choose-one__right">
                            <div class="section-title text-left">
                                <!-- <span class="section-title__tagline">why choose us</span> -->
                                <h2 class="section-title__title">Hire a highly efficient and talented team who will
                                    bring your ideas to life</h2>
                            </div>
                            <p class="why-choose-one__right-text">Our team of 600+ professionals (UI/UX Designers, Full
                                Stack Developers, QA, Business Analysts, and Security Experts) creates customized mobile
                                app solutions for iOS and Android mobile platforms, increasing your business
                                productivity. At ArtisticWebServices, you will be working with a team that combines technical and
                                business skills to provide a final result that will make your business stand out!</p>
                        </div>
                    </div>
                </div>
            </div>
