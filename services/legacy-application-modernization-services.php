...
<div class="location-hero">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <h1>Specialized Legacy Modernization Services</h1>
                        <p class="my-3">Upgrade, innovate, and future-proof your apps to propel your business to the forefront. 
                        </p>
                    ...
                    <div class="col-lg-6 d-flex justify-content-center banner-image-container">
                        <img src="<?= $B ?>/assets/images/specialized-modernization-services.webp" class="img-fluid animated-img" alt="Legacy application modernization services illustration">
                    </div>
                </div>
            </div>
                    </div>
        ...
        <div class="location-services pb-5">
            ...
            <div class="container">
                <div class="text-center" style="padding-top: 80px;">
                    <h2 class="text-white">Our Legacy Modernization Services </h2>
                    <p class="text-white w-75 d-block mx-auto">Our legacy modernization services have the ability to enhanced efficiency and responsiveness along with the assured and unparalleled user experience. Experience the next level of technological advancement with your legacy modernization solutions!</p>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Legacy Code  <br> Refactoring</h4>
                            <p class="mb-0 mt-3">Modernize your outdated codebase by refactoring it into clean and maintainable code and improving performance scalability. 
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Platform  <br> Migration </h4>
                            <p class="mb-0 mt-3">Migrate legacy apps from on-premises servers to modern cloud platforms, enhancing agility, scalability, and cost efficiency. 
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>UI/UX  <br> Modernization </h4>
                            <p class="mb-0 mt-3">Revamp the user interface experience of legacy apps to meet modern design standards and improve user satisfaction. 
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Integration With <br>Modern Technologies 
                            </h4>
                            <p class="mb-0 mt-3">Integrate legacy systems with modern technologies such as APIs, microservices, and IoT devices to unlock new capabilities and improve interoperability. </p>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Data Migration  <br> Modernization 
                            </h4>
                            <p class="mb-0 mt-3">Migrate legacy data to modern databases and data warehouses to ensure data integrity, security, and seamless accessibility.  
                    ...
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Legacy Application  <br> Decommissioning .
                            </h4>
                            <p class="mb-0 mt-3">Identify and decommission redundant or obsolete legacy applications and streamline your IT environment, reducing maintenance costs. 
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-section-bg pt-5">
            <div class="container">
                <h2>Legacy Application Refactoring 
                </h2>
                <p>Are you eager to take advantage of the blockchain technology services to your company? ArtisticWebServices have got your back with its professional team and support help you grow.</p>
                <p>With the refactoring of your legacy code, we improve maintainability of your mobile app while ensuring it stays competitive and longer in rapidly evolving digital landscape. With ArtisticWebServices' top-notch legacy modernization services, we transform outdated apps into modern and high-performance solutions that fuel business growth and spark innovation.</p>
               
                <img src="<?= $B ?>/assets/images/legacy-application-refactoring.webp"
                    alt="mobilize-your-vision-transformative-mobile-application-development" class="img-fluid">
            </div>
        </div>
