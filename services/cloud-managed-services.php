...
<div class="location-hero">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <h1>Optimize Your Cloud Infrastructure With ArtisticWebServices’ Cloud-Managed Services   </h1>
                        <p class="my-3">Maintain Your Lead in the Cloud with Smart and Proactive Admin Management
                        </p>
                    ...
                    <div class="col-lg-6 d-flex justify-content-center banner-image-container">
                        <img src="<?= $B ?>/assets/images/cloud-managed-services.webp" class="img-fluid animated-img" alt="Cloud managed services infrastructure illustration">
                    </div>
                </div>
            </div>
                    </div>
        ...
        <div class="location-services pb-5">
            ...
            <div class="container">
                <div class="text-center" style="padding-top: 80px;">
                    <h2 class="text-white">Our Cloud Managed Development Service  </h2>
                    <p class="text-white w-75 d-block mx-auto">Boost your online visibility and create an unparalleled user experience with our cloud-managed solution.  With ArtisticWebServices, discover the potential of simple cloud management right now!</p>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Cloud Monitoring   <br> Optimization </h4>
                            <p class="mb-0 mt-3">Keep an eagle eye on your cloud infrastructure’s performance and timely optimize resources to maintain cost and peformance efficiency.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Security Compliance   <br> Management</h4>
                            <p class="mb-0 mt-3">Implement smooth and strong security measures to lock the compliance with industrial rules and regulations to protect your data.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Automated  <br> BackUp   </h4>
                            <p class="mb-0 mt-3">Set up an automated recovery plans for any cause of disaster to minimize downtime and ensure full recovery in case of data loss or system failure.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Patch  <br> Management  
                            </h4>
                            <p class="mb-0 mt-3">Stay up to date with the latest software patch updates to mitigate security vulnerabilities and maintain system reliability. </p>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>24/7 Technical   <br> Support 
                            </h4>
                            <p class="mb-0 mt-3">Provide access to technical support in the 11th hour or even 24/7, anytime, anywhere, by our team of experts to look closely on the issues with your cloud environment promptly.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
                        <div class="service-card-location">
                            <h4>Performance  <br> Tuning.
                            </h4>
                            <p class="mb-0 mt-3">Fine-tune your cloud infrastructure for optimal performance and ensure smooth efficient operations for your applications services.   
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-section-bg pt-5">
            <div class="container">
                <h2>Cloud Infrastructure Optimization  
                </h2>
                <p>ArtisticWebServices offers comprehensive cloud-managed services designed to optimize your cloud infrastructure for maximum efficiency performance. Our cloud engineers works closely in collborative manner with your to assess your current setup and identify areas for improvement along with implementation of customized solutions to optimize resources, improve scalability and make it cost efficient.
                </p>
                <p>From fine-tuning performance to implementing automated backup disaster recovery strategies, we ensure that your cloud environment is robust, secure, and cost-effective, allowing you to focus on driving business growth.  </p>
                <img src="<?= $B ?>/assets/images/cloud-infrastructure-optimization.webp"
