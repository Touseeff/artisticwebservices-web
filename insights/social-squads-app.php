...
$page_keywords = 'social networking app development case study, community app development, social squads app, group activity app, social media platform development, community engagement app USA';
$page_canonical = 'https://artisticwebservices.com/insights/social-squads-app';
$page_og_image = 'https://artisticwebservices.com/assets/images/resources/artisticwebservice w.png';
$page_breadcrumbs = [['name' => 'Insights', 'url' => 'https://artisticwebservices.com/insights/digital-insights.php'], ['name' => 'Social Squads App', 'url' => 'https://artisticwebservices.com/insights/social-squads-app.php']];
$page_article_schema = ['type' => 'Article', 'date' => '2024-01-22'];
...
<section class="about-page socila-squad-bg white__main">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            <div>
                                ...
                                <h1 class="section-title__title mb-3">Build Lasting Connections with Social Squads!</h1>
                            </div>
                            <p class="laundry-content">"Social Squad: Your Ultimate Social Hub! Connect with friends, percentage your stories, and discover thrilling content. Create a vibrant profile, live updated along with your community, experience customized messaging, or even stay. </p>
                    ...
                    <div class="col-xl-5">
                        <!-- <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            ...
                            <img class="img-fluid" src="<?= $B ?>/assets/images/work/social-squad/Main.webp" alt="">
                        </div> -->
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            ...
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/work/social-squad/01.webp" alt=""> </div>
                    </div>
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            <div class="icon-counting mb-3">1</div>
                            <h2 class="section-title__title mb-3">What You'll Find First?</h2>
                            <p class="">"Welcome to Social Squad,  the social media platform designed to deliver humans closer.  With Social Squad,  you can create your digital identity,  percentage your studies,  and connect to buddies and like-minded individuals.  It's your gateway to a colorful and interactive social global. "</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            ...
                            <p class="">"Your Gateway to Social Squad! Access your world with a faucet.  Enter your electronic mail and password,  or click 'Forgot Password' in case you need a brief reset.  Join us in some clicks,  or genuinely sign on along with your Gmail.  Let's get started!"  </p>
                        </div>
                    </div>
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/work/social-squad/02.webp" alt=""> </div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInLeft;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/work/social-squad/03.webp" alt=""> </div>
                    </div>
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            <div class="icon-counting mb-3">3</div>
                            <h2 class="section-title__title mb-3">Home</h2>
                            <p class="">"Your Social Hub: The Home screen is where the magic takes place: post pix, movies, texts, or documents to proportion your tales along with your pals. Stay up to date with your community's today's updates, and scroll through the maximum trending content. </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            ...
                            <h2 class="section-title__title mb-3">Connections</h2>
                            <p class="">"Stay Connected: In the Connections segment, find and manage your friends. Add new connections, eliminate undesirable ones, and shoot them a direct message. Explore your organizations and pages, unfollow, file, or proportion. Your network, your manner."</p>
                        </div>
                    </div>
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/work/social-squad/04.webp" alt=""> </div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInLeft;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/work/social-squad/05.webp" alt=""> </div>
                    </div>
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            <div class="icon-counting mb-3">5</div>
                            <h2 class="section-title__title mb-3">Messages</h2>
                            <p class="">"Express Yourself with Messages: Send personalized messages with lively backgrounds, fonts, and shades. Stand out and make your messages precise. Set your privacy, and choose your audience. It's a characteristic that lets your words shine. (Paid feature, a small fee applies.)"</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7">
                        <div class=" mt-3">
                            ...
                            <h2 class="section-title__title mb-3">Stacy Doe</h2>
                            <p class="">"Meet Stacy Doe: Stacy Doe is your digital identity. View your profile, your buddies, and your own family's profiles, along with posts and photographs. It's your window on your international, your area, and your identity on Social Squad."</p>
                        </div>
                    </div>
                    <div class="col-xl-5 text-center">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms"
                            style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
                            <img width="270px" class="img-fluid"
                                src="<?= $B ?>/assets/images/work/social-squad/06.webp" alt=""> </div>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-xl-6">
                        <div class="welcome-three__left">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">Social Squad Application Overview</h2>
                            </div>
                            <p class="welcome-three__text"> Social Squad is your cross-to social media app, imparting a comprehensive platform for connecting, sharing, and exploring in an interesting and person-friendly way. 
                                <br>
                                <br> With Social Squad, you could create a unique digital identity with the aid of putting in a profile that displays your character, with a profile photograph that can be taken instantly or uploaded. 
                                <br>
                                <br>The app does not compromise on privacy and protection, allowing you to control your content's visibility and manage interactions. It additionally capabilities in-app messaging, Google Ad Mobs for monetization, and push notifications for actual-time updates. 
                                <br>
                                <br>For administrators, there may be an internet-based panel to manage users, content, advertisements, notifications, bills, and analytics.
                            </p>
                        </div>
                    </div>
