...
<section class="location-section" style="background-color: #fef7f7;">
          <div class="container">
            <div class="text-center mb-5">
              <h2 class="fw-bold" style="color: #dc3545;">Our Locations</h2>
              <!--<p class="text-muted">We proudly serve businesses in the following cities across the United States.</p>-->
            </div>
        
            <div class="row g-4 justify-content-center">
              <!-- Location Card -->
              <div class="col-6 col-md-4 col-lg-3">
                <a href="<?= $B ?>/services/mobile-app-development.php" class="location-card">
                  <div class="card h-100 shadow-sm border-0 text-center">
                    <div class="card-body">
                      <i class="bi bi-geo-alt-fill location-icon"></i>
                      <h5 class="mt-3">USA</h5>
                    </div>
                  </div>
                </a>
              </div>
              ...
              <div class="col-6 col-md-4 col-lg-3">
                <a href="<?= $B ?>/services/mobile-app-development" class="location-card">
                  <div class="card h-100 shadow-sm border-0 text-center">
                    <div class="card-body">
                      <i class="bi bi-geo-alt-fill location-icon"></i>
                      <h5 class="mt-3">San Francisco</h5>
                    </div>
                  </div>
                </a>
              </div>
