...
<section class="about-page consalting-bg white__main allience__partners">
        ...
        <section class="alience-content">
            <div class="container">
                <div class="section-title text-center mb-0">
                    <h2 class="section-title__title col-md-10 m-auto">Expert Digital Consultation</h2>
                </div>
            </div>
        </section>
        <!--Services Two End-->
        ...
        <section class="services-two alience__content ">
            <div class="container">
                <div class="section-title text-center mt-2">
                    <p>As a leading mobile app development company, ArtisticWebServices, offers top-tier consultation services in a way that no other company can to the businesses of all sizes, whether large enterprises or small businesses. With over 600+ successful projects under our streak, we take pride in providing the needs of our clients to the fullest by providing them with a solution that they have always desired.</p>
                    <p>Our expert guidance and consultation help startups and established enterprises alike, helping them to deliver tailored solutions that drive growth and success.</p>
                </div>
            </div>
        </section>
        <!--alience content end-->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="alience_list">
                            <ul>
                                <li>Tailored mobile app development strategies.</li>
                                <li>In-depth market analysis and insights.</li>
                                <li>Scalable app architecture planning.</li>
                                <li>Expert UI/UX design recommendations.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="alience_list">
                            <ul>
                                ...
                                <li>Latest tech and trend consultations.</li>
                                <li>Strategic growth and scaling advice.</li>
                                <li>Ongoing support for long-term success.</li>
                            </ul>
                        </div>
                    </div>
                </div>
